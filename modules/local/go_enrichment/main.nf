...
process GO_ENRICHMENT {
    ...
    """
    run_go_enrichment.R ${unfiltered_deg_flag} ${pvalue_threshold} ${logfc_threshold_flag} ${species_name} ${wgcna_list_flag} ${masigpro_list_flag} ${genes_diu_flag} ${genes_deu_flag} ${ntop_processes}
