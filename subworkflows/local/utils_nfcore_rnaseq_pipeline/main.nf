...
def toolCitationText() {
    def citation_text = [
        ...
        !params.skip_bbsplit ? "BBSplit (<a href=\"https://doi.org/10.1371/journal.pone.0185056\" target=\"_blank\">Bushnell et al., 2017</a>)," : "",
        !params.skip_sortmerna ? "SortMeRNA (<a href=\"https://doi.org/10.1093/bioinformatics/bts611\" target=\"_blank\">Kopylova et al., 2012</a>)," : "",
        ...
        params.aligner == "hisat2" && "GVC" in params.analysis_method.split(",") ? "SnpEff (<a href=\"https://doi.org/10.4161/fly.19695\" target=\"_blank\">Cingolani et al., 2012</a>)," : "",
...
def toolBibliographyText() {
    def reference_text = [
        ...
        !params.skip_multiqc ? "<li>Ewels, P., Magnusson, M., Lundin, S., &amp; Käller, M. (2016). MultiQC: summarize analysis results for multiple tools and samples in a single report. <em>Bioinformatics</em>, <em>32</em>(19), 3047–3048. doi: <a href=\"10.1093/bioinformatics/btw354\" target=\"_blank\">10.1093/bioinformatics/btw354</a></li>" : "",
        !params.skip_bbsplit ? "<li>Bushnell, B., Rood, J., & Singer, E. (2017). BBMerge - Accurate paired shotgun read merging via overlap. <i>PLoS One</i>, 12(10), e0185056. doi: <a href=\"https://doi.org/10.1371/journal.pone.0185056\" target=\"_blank\">10.1371/journal.pone.0185056</a></li>" : "",
        !params.skip_sortmerna ? "<li>Kopylova, E., Noé, L., & Touzet, H. (2012). SortMeRNA: fast and accurate filtering of ribosomal RNAs in metatranscriptomic data. <i>Bioinformatics</i>, 28(24), 3211–3217. doi: <a href=\"https://doi.org/10.1093/bioinformatics/bts611\" target=\"_blank\">10.1093/bioinformatics/bts611</a></li>" : "",
        ...
        params.aligner == "hisat2" && "GVC" in params.analysis_method.split(",") ? "<li>Cingolani, P., Platts, A., Wang, L. L., Coon, M., Nguyen, T., Wang, L., ... Ruden, D. M. (2012). A program for annotating and predicting the effects of single nucleotide polymorphisms, SnpEff: SNPs in the genome of Drosophila melanogaster strain w1118; iso-2; iso-3. <i>Fly</i>, 6(2), 80–92. doi: <a href=\"https://doi.org/10.4161/fly.19695\" target=\"_blank\">10.4161/fly.19695</a></li>" : "",
